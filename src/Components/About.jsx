  ...
  return (
    <section className="py-16 bg-gradient-to-br from-white via-gray-100 to-gray-200 text-gray-900 px-6 sm:px-10">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-3 gap-8 max-w-6xl mx-auto">
        ...
        {/* Card 2 */}
        <motion.div
          className="p-6 bg-[#9333ea] text-white rounded-lg shadow-lg"
          animate={{
            rotate: [0, 10, -10, 0],
          }}
          transition={{
        ...
        >
          ...
          <ul className="list-disc pl-4 space-y-2">
            ...
            <li>Collaborated with agile teams</li> */}
            <p>I am currently pursuing a Bachelor's degree in Computer Science (BSCS) and have completed my 7th semester at the University of Engineering and Technology (UET). I have also completed internships at two different companies, Apex Space and Heal Labs, where I gained valuable experience and earned certificates</p>
          </ul>
        </motion.div>
